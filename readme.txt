...
The conversion automatically strips all blanks (spaces and TABs) from the code leaving only 1 space throughout. This amount can be changed with:
...
Mantains the original spacing used on the source code (TABs and spaces).
